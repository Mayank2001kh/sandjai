...
import AddNewCompany from "../views/Company/AddNewCompany";
...
export const routes = [
  ...
  { path: "apps/company/companies", exact: true, component: Companies },
  {
    path: "apps/company/add-new-company",
    exact: true,
    component: AddNewCompany,
  },
  //   { path: "apps/company/post-company", exact: true, component: PostDetail },
