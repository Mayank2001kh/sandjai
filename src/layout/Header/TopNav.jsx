      ...
      <Container fluid>
        ...
        <div className="nav-end-wrap">
          <Nav className="navbar-nav flex-row">
                ...
                >
                  ...
                  <SimpleBar className="dropdown-body p-2">
                    <Offcanvas.Body className="p-0">
                      <Dropdown.Header className="px-4 fs-6"></Dropdown.Header>
                            ...
                            <div className="media-body">
                              <div>
                                <div className="notifications-text">
                                  Morgan Freeman accepted your invitation to
                                  join the team
                                </div>
                        ...
                        <Dropdown.Item>
                          <div className="media">
                            ...
                            <div className="media-body">
                              <div>
                                <div className="notifications-text">
                                  Last 2 days left for the project to be
                                  completed
                                </div>
                                <div className="notifications-info">
            ...
            <Nav.Item>
              <Button
                className="d-flex gap-1 align-items-center justify-content-between mx-1 fs-7 "
                variant="primary"
                style={{ minWidth: "7rem" }}
              >
                <Clock size={20} />
            ...
            <Nav.Item>
              <Button
                className="d-flex align-items-center fs-7 mx-1"
                variant="danger"
              >
                Logout
              </Button>
